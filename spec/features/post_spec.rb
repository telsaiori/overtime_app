...
describe 'navigate' do
  ...
  describe "index" do 
    ...
    it "has s scope so that only post creater can see their post" do 
  ...
  describe "delete" do 
    it "can be deleted" do 
      ...
      post_to_delete = Post.create(date: Date.today, rationale: 'any', user_id: delete_user.id, overtime_request: 3.5)
